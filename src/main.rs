...
const APP_NAME: &str = "Useful for everyday commands";
...
fn main() -> Result<(), Box<dyn Error>> {
	let matches = Command::new(APP_NAME)
		...
		.about(concat!("A Tool With Several Commands Useful For Everyday, Large Files Finder & Markdown To HTML Converter \n\nEXAMPLES:\n", concat_line!(prefix "tuop-ls ",
	...
	.arg(Arg::new("NO_HIGHLIGHT")
		...
		html_minifier.digest(format!(
			"<meta name=\"generator\" content=\"{} {} by TuNiDev\"/>",
